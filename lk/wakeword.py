...
class WakeWordTrackDetector:
    ...
    A diferencia de WakeWordDetector (que abre el mic LOCAL con portaudio), este consume un
    rtc.AudioStream sobre el track del mic del BROWSER -> corre en el worker headless. Reusa el
    MISMO modelo/threshold/beep. Replica la ventana deslizante de 2s del WakeWordListener nativo,
    pero alimentada por el track en vez del mic local.
