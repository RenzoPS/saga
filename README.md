...
Hay más estados que los cuatro de arriba: `transcribe`, `screen` (mirando pantalla), y
transitorios como `nueva`, `error`, `cancel` y `attach`, que se muestran un ratito y vuelven
solos al estado de base.
