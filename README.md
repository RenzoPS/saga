...
Hay más estados que estos cuatro: `transcribe`, `screen` (mirando pantalla), y transitorios como
`nueva`, `error`, `cancel` y `attach`, que se muestran un ratito y vuelven solos al estado de
base.
